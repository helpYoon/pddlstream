...
from examples.pybullet.utils.pybullet_tools.pr2_problems import create_pr2, create_kitchen_llm
...
def get_kitchen_task(arm='left', grasp_type='top'):
    ...
    cabbage, tomato, spoon, fork, table, refridgerator, sink, stove = create_kitchen_llm()
    floor = get_bodies()[1]
    class_from_body = {
        cabbage: 'cabbage',
        tomato: 'tomato',
    ...
    movable = [cabbage, tomato, spoon, fork]
    surfaces = [table, refridgerator, sink, stove]
    rooms = [floor]
